...
class Serial_Stm32f4(object):
    ...
    def initializing_values(self):
        ...
        self.valor_numerico1        = 0.0  #Prueba
        self.valor_numerico2        = 0.0  #Prueba
        self.valor_numericoR1        = 0.0  #Prueba
   #     self.valor_numerico1 = 0
   #     self.valor_numerico2 = 0
   #     self.valor_numericoR1 = 0
    ...
    def creating_data_vectors(self):
        ...
        self.valor_numerico1_vector          = [] #PRueba
        self.valor_numerico2_vector          = [] #PRueba
    ...
    def create_log_file(self):
        ...
        elif self.print_selection==20: tag='FixedPoint_FloatPoint'
        else                        : tag=''
    ...
    def get_data_and_checksum(self):
                    ...
                    #print "convertion: " + str(convertion[1])
                    if (convertion[0]==True):                      
                        data = convertion[1]
                        self.transmition_error=False
    ...
    def get_data_and_checksum_ints(self):
                    bytes=1
                    info=''
                    i=0
                    while i<4:
                    ...
                    print "info: " + str(info)
                    #a = [49]
                    #print "info: " + str("".join(map(chr,a)))
                    convertion = bytes_to_int(info)
                    #convertion = "".join(map(chr,info))  #This test is for train to get strings from bytes
                    #convertion = str(info)
                    print "convertion: " + str(convertion[1])
                    if (convertion[0]==True):                      
                        data = convertion[1]
    ...
    def get_data_and_checksum_string(self):
                    ...
                    #a = [49]
                    #print "info: " + str("".join(map(chr,a)))
                    convertion = bytes_to_string(info)
                    #convertion = "".join(map(chr,info))  #This test is for train to get strings from bytes
                    #convertion = str(info)
                    #print "convertion: " + str(convertion[1])
                    if (convertion[0]==True):                      
