...
*/
float P_SENSORLESS      = 0.0000001f; 
float P_DOWN_SENSORLESS = 0.0000001f; 
float fake_P_SENSORLESS = 0.0f;
...
*/
float P_SENSORLESS_TORQUE      = 0.00001f;//0.00001f; //0.000001f
float P_DOWN_SENSORLESS_TORQUE = 0.00001f;//0.00001f; //0.000001f
float fake_P_SENSORLESS_TORQUE = 0.0f;
