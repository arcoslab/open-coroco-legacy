...
float P_SENSORLESS      = 0.01f;//0.00001f; 
float P_DOWN_SENSORLESS = 0.01f;//0.00001f; 
float fake_P_SENSORLESS = 0.01f;

float I_SENSORLESS      = 0.0f;//0.0000000000000001f;//0.0000000000001f//0.000000000000001f //0.000000000001f
float I_DOWN_SENSORLESS = 0.0f;//0.0000000000000001f;//0.0000000000001f//0.000000000000001f //0.000000000001f
float fake_I_SENSORLESS = 0.0f;




float P_SENSORLESS_TORQUE      = 0.0f;//125.0f;//0.0005f;//0.00001f; //0.000001f
float P_DOWN_SENSORLESS_TORQUE = 0.0f;//125.0f;//0.0005f;//0.00001f; //0.000001f
float fake_P_SENSORLESS_TORQUE = 0.0f;//125.0f;

float I_SENSORLESS_TORQUE      = 0.005f;//0.0000000000000001f;//0.0000000000001f//0.000000000000001f //0.000000000001f
float I_DOWN_SENSORLESS_TORQUE = 0.005f;//0.0000000000000001f;//0.0000000000001f//0.000000000000001f //0.000000000001f
float fake_I_SENSORLESS_TORQUE = 0.005f;
