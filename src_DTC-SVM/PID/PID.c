...
float P_SENSORLESS      = 0.0f;//0.00001f; 
float P_DOWN_SENSORLESS = 0.0f;//0.00001f; 
...
float P_SENSORLESS_TORQUE      = 10000.0f;//125.0f;//0.0005f;//0.00001f; //0.000001f
float P_DOWN_SENSORLESS_TORQUE = 10000.0f;//125.0f;//0.0005f;//0.00001f; //0.000001f
float fake_P_SENSORLESS_TORQUE = 10000.0f;//125.0f;
