...
class Serial_Stm32f4(object):
    ...
    def initializing_values(self):
        ...
        self.tag_comment        = ''
        self.aditional_comment='    CLOSE LOOP 270, NO CURRENT MEDIA AVERAGE FILTER BUFFER 50,LAG COMP 1.0,CURRENT OFFSET 0.0,open-loop 0.00005f,Ud 40%,finalfreq 250Hz,Fcutoff 5Hz'
