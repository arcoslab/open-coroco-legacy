...
#define VREF 2.966f	//ADC conversion reference voltage //STM32f4 VDD 

//from 3V to the real current
#define R_SHUNT_A 0.05f//0.05527f
#define R_SHUNT_B 0.05f//(0.05f/1.04f)//0.0555149f
#define V_DIFFERENTIAL_AMPLIFIER_REFFERENCE_A 1.49f//1.48f//1.3622f//1.51458f//1.4911f//1.487f //1.5015306f
#define V_DIFFERENTIAL_AMPLIFIER_REFFERENCE_B 1.49f//1.493f//1.3256f//1.47285f//1.496176f//1.487f //1.5015306f
