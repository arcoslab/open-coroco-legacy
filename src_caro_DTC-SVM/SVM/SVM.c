...
//To get the resitance value:
//test to get the resistance phase A
 //      *VsD = 2.0f;
 //      *VsQ = 0.0f;


//test to get the resistance phase B
//       *VsD = 2.0f*fast_cos(120.0f);
//       *VsQ = 2.0f*fast_sine(120.0f);

//test to get the resistance phase C
 //      *VsD = 2.0f*fast_cos(240.0f);
 //      *VsQ = 2.0f*fast_sine(240.0f);
