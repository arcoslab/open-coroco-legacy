...
while True:
    ...
    stm32_2=motor.checking_motor_position('3',stm32_3,in_3,in_2_name)
    ...
    try:
        ...
        while motor.connected==True:
            ...
            if motor.position=='4':            
                ...
                motor.receive_a_motor_bottle(in_3,in_3_name) 
